...
public class InputHandler
{
    ...
    /**
     * printAccuracy prints the accuracy of the results stored in myResults given the actual results
     * from testData.
     */
    public static void printAccuracy(int[] myResults, int[][] testData)
    {
        if (myResults.length != testData.length)
            throw new java.lang.Error(
                    "Please provide exactly one classification for each test instance.");
        ...
        System.out.printf("Percent Accuracy: %.2f",
                (correctClassifications / totalTestInstances * 100));
        System.out.println("%");
